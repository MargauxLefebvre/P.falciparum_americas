...
* Primary filters for the data from *P. falciparum* Community Project conducted by MalariaGen
* Mapping and calling for the added data (Brazil, Haiti and French Guiana)
